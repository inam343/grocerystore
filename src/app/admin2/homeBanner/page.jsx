  ...
  return (
    <div className="pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-800">Home Banner</h1>
          <p className="text-sm text-gray-400 mt-1">Manage the banners displayed on your home page.</p>
        </div>
