          ...
          <div className='flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6'>
            ...
            <form className='flex flex-col sm:flex-row flex-1 gap-2'>
              <input
                ...
                className='flex-1 w-full h-16 sm:h-20 rounded-lg px-4 bg-white border border-gray-300 outline-none text-sm focus:border-green-500 transition-colors'
              />
              <button className='w-full sm:w-auto h-11 sm:h-10 px-5 bg-[#02B290] hover:bg-[#029070] text-white text-sm font-semibold rounded-lg transition-colors whitespace-nowrap'>
                Subscribe
              </button>
            </form>
          </div>
