          ...
          <div className='flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6'>
            ...
            <form className='flex flex-col sm:flex-row flex-1 gap-2'>
              <input
                ...
                className='flex-1 w-full h-12 sm:h-10 md:h-10 rounded-lg px-4 bg-white border border-gray-300 outline-none text-sm focus:border-green-500 transition-colors'
              />
