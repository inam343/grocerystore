...
const Navbar = () => {
    return (
        <nav className="py-3 ">
            <div className="flex items-center justify-center gap-5 sm:gap-8 md:gap-10 bg-[#202124]  sm:bg-transparent md:bg-transparent  h-[40px] rounded-lg sm:px-15 md:px-15 lg:px-15  ">
