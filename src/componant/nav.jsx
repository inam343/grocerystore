...
const Navbar = () => {
    return (
        <nav className="py-3  ">
            <div className="flex items-center justify-center gap-5 sm:gap-8 md:gap-10  bg-white  sm:bg-transparent md:bg-transparent  h-[40px] rounded-lg sm:px-15 md:px-15 lg:px-15  ">
                <Link href="/" className=" text-[15px] sm:text-[16px] md:text-[18px] text-gray-800  sm:text-gray-800 md:text-gray-800 lg:text-gray-800 font-[600] hover:text-green-600">Home</Link>
