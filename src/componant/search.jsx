...
{
    return(
<div className='search bg-[#E6E6E6] h-[30px] dark:bg-transparent sm:w-[500px] md:h-[40] md:w-[600px] w-[100px] rounded-md px-4 relative border border-[rgba(0,0,0,0.1)] hover:border-[rgba(0,0,0,0.5)]'>
